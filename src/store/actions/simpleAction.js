...
export const simpleAction = () => {
  return dispatch => {
    axios.get(session_url, { headers: { 'Authorization': 'eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxMywiZXhwIjoxNTYzNjIwODQwfQ.G2RvMxMgtcs5_i9mE5ZtCWCklE8n5MqcRXsOqS7iW7w' } }).then(function (response) {
      dispatch({
        type: 'SIMPLE_ACTION',
